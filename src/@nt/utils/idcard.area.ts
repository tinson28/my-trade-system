...
/**
 * 根据身份证号取得发证地，身份证号前六位映射到地区的结果,
 * 例如“110101--北京市东城区”“411202--河南省三门峡市湖滨区”
 */
export function getAreaByIdCard(idCard): any {
  ...
  const province = data.province[provinceNo];
  const city = data.city[cityNo];
  const county = data.county[countyNo];
